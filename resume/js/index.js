$(function(){
	...
	function tvMiddle(){
		...
		console.log('暂不支持低版本IE，后续更新！--From SingleXu')
	}
	tvMiddle();
	...
	function tvContChange(){
		...
		setTimeout(function(){
			...
			$my_exp_box.removeClass('my_intern_cont_move');
		},100);
	}
	...
	$control_cats.click(function(){	
		...
		if (data_status == "on") {
			...
			// 点击其他经历
				...
				$my_exp.show();
				setTimeout(function(){
					$my_exp_box.addClass('my_intern_cont_move');
				},200);	
			}
		}
		else{
